...
<div class="container">
  ...
  <div class="content-wrapper">
    <h2 class="section-title">High School Book</h2>
        ...
        <!-- <div class="publication"> -->
          <a href="" class="publication">
            ...
            <div class=" col-md-12 col-xs-7 col-sm-7 pub-detail">
              <h4 class="pub-title">$book->title}} </h4>
              <small><b>Date</b> : $book->date}}</small>
              <p class="pub-summary">
              </p>
              <span class="margin-top-10" style="color: red;">$ ok->price}}</span>
